    ...
    <section class="row" style="height:100%;">
      <div class="col-md-5" style="height:100%; width:100%; display:flex; align-items:center; ">
        <!-- <div class="card-custom shadow" style="height:98%; width:98%; position:relative;"> -->
          ...
          <!-- Illustration image -->
          <img src="images/auth_bg.png" style="height:98%; width:98%; border-radius:20px;" class="">
        <!-- </div> -->
      </div>
        <!-- Logo -->
      ...
      <form method="POST" action="" style="display:flex; align-items:center; flex-direction:column; width:80%;" class="">
