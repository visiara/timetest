            ...
            <div class="row p-4">        
                ...
                <div class="row py-4">
                    <div class="table-responsive">
                        <table class="table table-bordered align-middle text-center text-muted" id="employeeTable">
                            ...
                            <tr>
                                ...
                                <img src="images/10.png" class="table-avatar" alt="Avatar"> Turi O.
                                </td>
                                <td>Heckerbella HQ</td>
                                <td><span class="badge bg-light text-dark">Operations</span></td>
                            ...
                            <tr class="last-row">
                                <td colspan="8" class="pagination-tb">
                                <!-- Pagination -->
                                <!-- <nav> -->
