  ...
  if (!empty($employeeid)) {
    ...
    if($hup > 0){
      if($atype == 'ClockIn'){
        ...
        if($hupx > 0){
          $saveinsert1 = "UPDATE attendance SET timeIn='$timeIn', timeInseconds='$timeInseconds', deviceid='$deviceid', attendance='$attendance' WHERE employeeid='$employeeid' AND date='$date' AND company = '$company'";
        } else {
          $saveinsert1 = null;
        }
        ...
        if($hupx > 0){
          $saveinsert1 = "UPDATE attendance SET timeOut='$timeOut', timeOutseconds='$timeOutseconds', totaltime='$totaltime', totaltimeseconds = '$totaltimeseconds', deviceid='$deviceid', attendance='$attendance' WHERE employeeid='$employeeid' AND date='$date' AND company = '$company'";
        } else {
          $saveinsert1 = null;
        }
...
if ($uri[3] == 'upload_attendance') {
  ...
  $value = json_decode($someJSON);
    ...
    if (!empty($employeeid)) {
      ...
      if($hup > 0){
          $saveinsert1 = "UPDATE attendance SET timeIn='$timeIn', timeInseconds='$timeInseconds', timeOut='$timeOut', timeOutseconds='$timeOutseconds', totaltime='$totaltime', totaltimeseconds='$totaltimeseconds', deviceid='$deviceid', attendance='$attendance' WHERE employeeid='$employeeid' AND date='$date' AND company='$company'";
          if(mysqli_query($conn, $saveinsert1)){
