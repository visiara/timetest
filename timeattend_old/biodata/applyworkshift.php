...
<div class="alert alert-success" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    ...
    <span><strong>Success!</strong> Employee Workshift Applied Successfully.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
    ...
    <div class="br-mainpanel">
      <div class="br-pagetitle">
        ...
        <div>
          ...
          <p class="mg-b-0">Employee Work Schedule Management - All Employee.</p>
        </div>
      </div><!-- d-flex -->
      ...
      <div class="row row-sm mg-t-20">
          <div class="col-lg-12">
            <div class="card bd-0 shadow-base widget-14 ht-100p">
              <div class="card-body">
                <div class="card-title">Employee Work Schedule</div>
...
?>
    ...
    <div class=" mg-b-0">
      <div class="form-group mg-b-0-force">
        ...
        <select class="form-control select2" id="fruit_select" name="employee[]" data-placeholder="Select Employee(s)" multiple required>
<?php
if($user_role == "3"){
