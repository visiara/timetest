...
$x = '0';
$huserbd5=mysqli_query($conn, "SELECT * FROM employee WHERE uname = '$uid' AND status = 'Active' AND company='$companyMain'");
...
// total no of days absent authorised
$thu12=mysqli_query($conn, "SELECT * FROM attendance WHERE date >= '$date1' AND date <= '$date2' AND employeeid = '$employeeid' AND company='$companyMain' AND attendancereport = 'Exemption'");
