...
if(isset($_GET['pid'])){
    ...
    if(mysqli_query($conn, $saveinsert1)){
        ...
        <strong>Well done!</strong> You successfully Clocked-Out the Employee.
    </div>';
    } else {
...
?>
                <tr>
                  ...
                  <td>
                    <?php if($aover == "0"){ ?>
                    <a href="?pid=<?php echo $did; ?>&date=<?php echo $ddate; ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure you wish to Clock-Out this Employee?');">Clock Out</a>
                    <?php } ?>
                  </td>
                </tr>
<?php
