...
$saveinsert1 = "UPDATE company SET companyname='$companyname', compref='$pref', startdate='$startdate', enddate='$enddate', comaddress='$companyaddress', comephone='$companyphone', comemail='$companyemail', masterkpi='$kpiy', mastersalary='$salay' WHERE id='$theid'";
...
$saveinsert1 = "INSERT INTO company (`companyname`, `compref`, `status`, `createdby`, `dele`, `deleby`, `startdate`, `enddate`, `regdate`, `comaddress`, `comephone`, `comemail`, `masterkpi`, `mastersalary`) VALUES ('$companyname', '$pref', 'Active', '$uid', '0', '0', '$startdate', '$enddate', '$regd', '$companyaddress', '$companyphone', '$companyemail', '$kpiy', '$salay')";
if(mysqli_query($conn, $saveinsert1)){
