    ...
    <div class="br-mainpanel">
      <div class="br-pagetitle">
        ...
        <div>
          ...
          <p class="mg-b-0">Employee Management Panel - All Employee.</p>
        </div>
      </div><!-- d-flex -->
      ...
      <div class="br-pagebody">
        ...
        <?php echo $status; ?>
          <button class="btn btn-teal" data-toggle="modal" data-target="#addemployee"><i class="fa fa-plus mg-r-10"></i> Add Employee</button>
          <button class="btn btn-teal" data-toggle="modal" data-target="#modaldemo6"><i class="fa fa-plus mg-r-10"></i> Import Employee Information</button>
          <button class="btn btn-teal" data-toggle="modal" data-target="#assemployeemodal"><i class="fa fa-plus mg-r-10"></i> Group Assign Employee</button>
...
<script>
        ...
        function douser(){
          var a = document.getElementById('employeeid');
...
<input type="hidden" name="addp" value="1">
    ...
    <div class="d-flex mg-b-20">
      ...
      <div class="form-group mg-b-0 mg-l-10">
        ...
        <input type="date" name="dofb" class="form-control" placeholder="YYYY-MM-DD" id="dateMask" required>
      </div><!-- form-group -->
      <div class="form-group mg-b-0 mg-l-10">
  ...
  <option value="Female">Female</option>
    ...
    <div class="d-flex mg-b-20">
      <div class="form-group mg-b-0">
        ...
        <select class="form-control select2 " name="country" id="country" data-placeholder="Choose Country" onchange="ChangeState(this.value)" required>
  ...
  <label class="custom-file-label"></label>
    ...
    <div class="d-flex mg-b-20">
      <div class="form-group mg-b-0">
        ...
        <input type="text" name="uniqid" class="form-control" placeholder="Unique ID" value="<?php echo $companyref.$coolo; ?>" required readonly>
      </div><!-- form-group -->
      <div class="form-group mg-l-10 mg-b-0">
        <label>Employee ID: <span class="tx-danger">*</span></label>
        <input type="text" id="employeeid" name="employeeid"  class="form-control" placeholder="Employee ID" onblur="douser()" onchange="douser()" onkeyup="douser()" required>
      </div><!-- form-group -->
    </div>
...
?>
    ...
    <div class="d-flex mg-b-0">
      <div class="form-group mg-b-0-force">
        ...
        <input type="text" id="uname" name="uname" class="form-control" placeholder="Employee Username" readonly required>
      </div><!-- form-group -->
...
<!-- Group Assign employee -->
          <div id="assemployeemodal" class="modal fade effect-newspaper">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content tx-size-sm">
                <div class="modal-header pd-x-20">
                  <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Assign Employee (s)</h6>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
...
<form id="assemployeeshow" action="" method="POST">
    ...
    <div class="form-group mg-b-0-force">
        ...
        <select class="form-control select2" id="atype" name="atype" data-placeholder="Choose what to assign" onchange="ass(this.value);" required>
    ...
    <div class=" mg-b-40">
      <div class="form-group mg-b-0-force">
        <label>Select Employee: <span class="tx-danger">*</span></label>
        <select class="form-control select2" id="fruit_select" name="employee[]" data-placeholder="Select Employee(s)" size="10" multiple required>
<?php
...
?>
<option value="<?php echo $inid3vb; ?>">( <?php echo $employeeid3vb; ?> ) <?php echo $lname3vb." ".$mname3vb." ".$fname3vb; ?></option>
<?php
}
?>
        </select>
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-primary tx-size-xs" form="assemployeeshow">Assign Employee(s)</button>
                  <button type="button" class="btn btn-secondary tx-size-xs" data-dismiss="modal">Close</button>
                </div>
              </div>
            </div><!-- modal-dialog -->
                      ...
                      <div class="row no-gutters">
                        <div class="col-lg-6 bg-primary">
                          <div class="pd-40">
                            ...
                            <p class="tx-white op-7 mg-b-10">The upload file MUST be a comma seperated CSV file arranged in the table structure below.</p>
                            <p class="tx-white op-7 mg-b-20">All headers must be removed and first colun must be Employee ID column. Check sample file below</p>
                            <p class="tx-white tx-13">
                              <span class="tx-uppercase tx-medium d-block mg-b-5">Table Structure:</span>
                              <span class="op-7">
                              Employee ID = CSV column[0]</br>
                            ...
                            <div class="mg-t-30 mg-b-0 tx-white tx-12">Sample CSV file? <a href="BIPATAS_sample_file.csv" class="tx-white" download rel="noopener noreferrer" target="_blank"> Click to Download</a></div>
                            </div>
                          </div><!-- col-6 -->
                          <div class="col-lg-6 bg-white">
                            <div class="pd-30">
                              ...
                              <div class="pd-x-30 pd-y-10">
                                <h3 class="tx-inverse  mg-b-5">Upload Employees</h3>
                                ...
                                <div class="form-group mg-b-15">
                                  ...
                                  <input type="file" name="file" id="filecsv" class="form-control pd-y-12" onchange="return fileValidation3()" required/>
                                </div><!-- form-group -->
                                
                                <div class="form-group mg-b-15">
        <label>Country: <span class="tx-danger">*</span></label>
        <select class="form-control select2 " name="country" id="countryU" data-placeholder="Choose Country" onchange="ChangeStateU(this.value)" required>
          <option value="">Choose Country</option>
<?php
$intload14gb=mysqli_query($conn, "SELECT * FROM country ORDER BY id asc");
while ($intload14agb = mysqli_fetch_array($intload14gb))
      ...
      <div class="form-group mg-b-20" id="stateidU">
        ...
        <select class="form-control select2 " name="state" data-placeholder="Choose State" required>
          <option value="">Choose State</option>
                                ...
                                <input class="btn btn-primary pd-y-12 btn-block" type="submit" name="submit_file" value="Upload Employees"/>
