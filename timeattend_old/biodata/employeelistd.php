...
<div class="alert alert-success" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    <i class="icon ion-checkmark alert-icon tx-20 mg-t-5 mg-xs-t-0"></i>
    <span><strong>Success!</strong> Employee Successfully Restored.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}
    ...
    <div class="br-mainpanel">
      <div class="br-pagetitle">
        ...
        <div>
          ...
          <p class="mg-b-0">Employee Management Panel - Deleted Employee.</p>
        </div>
      </div><!-- d-flex -->
      ...
      <div class="br-pagebody">
        ...
        <?php echo $status; ?>
        <h4 class="mg-b-0">Deleted Employee</h4>
