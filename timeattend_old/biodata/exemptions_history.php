    ...
    <div class="br-mainpanel">
      <div class="br-pagetitle">
        ...
        <div>
          ...
          <p class="mg-b-0">Employee Exemption History Panel.</p>
        </div>
      </div><!-- d-flex -->
...
//$huserbd5=mysqli_query($conn, "SELECT * FROM exemption WHERE employeeid='$loggedid' AND (approvals = '0' OR approvals = '9') AND company='$companyMain'");
$huserbd5=mysqli_query($conn, "SELECT * FROM exemption WHERE employeeid='$loggedid' AND company='$companyMain'");
