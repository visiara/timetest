...
<div class="alert alert-success" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    ...
    <span><strong>Success!</strong> Employee Exemption Type Successfully Updated</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}
...
<div class="alert alert-success" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    <i class="icon ion-checkmark alert-icon tx-20 mg-t-5 mg-xs-t-0"></i>
    <span><strong>Success!</strong> Employee Exemption Type Successfully Deleted.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}
...
$saveinsert1 = "UPDATE exemptiontype SET name ='$name4', days='$days4', plevel='$plevel4', createdby='$uid' WHERE id='$theid'";
...
<div class="alert alert-danger" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    ...
    <span><strong>Opps!</strong> Error Updating Employee Exemption Type.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}
...
$saveinsert1 = "INSERT INTO exemptiontype (`name`, `days`, `plevel`, `createdby`, `company`) VALUES ('$name4', '$days4', '$plevel4', '$uid', '$companyMain')";
if(mysqli_query($conn, $saveinsert1)){;
$status = '
<div class="alert alert-success" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
  ...
  <div class="d-flex align-items-center justify-content-start">
    <i class="icon ion-checkmark alert-icon tx-20 mg-t-5 mg-xs-t-0"></i>
    <span><strong>Success!</strong> Employee Exemption Type Successfully Inserted.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}else{
...
<div class="alert alert-danger" role="alert">
  ...
  <div class="d-flex align-items-center justify-content-start">
    <i class="icon ion-times alert-icon tx-20 mg-t-5 mg-xs-t-0"></i>
    <span><strong>Opps!</strong> Error Inserting Employee Exemption Type.</span>
  </div><!-- d-flex -->
</div><!-- alert -->
';
}
