...
$output.='<p>-------------------------------------------------------------</p>';
$output.="<p><a href=$websiteMain/biodata/password_reset.php?key=$key&email=$email&action=reset target=_blank>$websiteMain/biodata/password_reset.php?key=$key&email=$email&action=reset</a></p>";		
$output.='<p>-------------------------------------------------------------</p>';
