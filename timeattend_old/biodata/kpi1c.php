...
<?php if(!empty($endinfo)){ ?>
                            <p class="tx-white">
                              ...
                              <span class="op-7"><?php echo $endinfo; ?></span></p>
<?php } ?>
        </div>
</div><!-- col-6 -->
...
<input type="hidden" name="score" value="1">
                              ...
                              <div class="pd-x-30 pd-y-10">
                                <h3 class="tx-inverse  mg-b-5">KPI Score Card!</h3>
                                <p>Report and percentage score for this KPI.</p>
<?php if($dpoll > "0"){ ?>
                                <h3 class='tx-inverse  mg-b-5'>KPI score is <?php echo "$dpoll%"." ".$btnicon3; ?></h3>

                                <div class="form-group">
                                  <textarea name="rep" rows="3" class="form-control pd-y-12" placeholder="Report" disabled><?php echo $endinfo; ?></textarea>
                                </div><!-- form-group -->
                                
                                <div class="input-group mg-b-20">
                                  <input type="number" name="achievement" id="achievementk" class="form-control pd-y-12" placeholder="0" value="<?php echo $achieveg; ?>" disabled>
                                ...
                                <div class="input-group mg-b-20">
                                  <input type="number" name="weight" id="weightk" class="form-control pd-y-12" placeholder="0" value="<?php echo $weightg; ?>" disabled>
                                  <div class="input-group-append">
                                ...
                                <div class="input-group mg-b-20">
                                  <input type="number" name="grade" id="gradek" class="form-control pd-y-12" placeholder="0" value="<?php echo $dpoll; ?>" disabled>
                                  <div class="input-group-append">
                                    <span class="input-group-text">Grade / Score</span>
                                  </div>
                                </div><!-- input-group -->
      <?php if($fstatus == "1"){ ?>
                                <button type="submit" class="btn btn-primary pd-y-12 btn-block">Contest Score</button>
      <?php } ?>
