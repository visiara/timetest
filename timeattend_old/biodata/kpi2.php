...
//$huserbd5=mysqli_query($conn, "SELECT * FROM kpi_list WHERE employeeid='$loggedid' AND status = 'Active' AND company='$companyMain' AND kpitype='Individual' ORDER BY id desc");
$huserbd5=mysqli_query($conn, "SELECT COUNT(id) AS dcount, SUM(kweight) AS kweight, SUM(kachieve) AS kachieve, SUM(dpoll) AS dpoll, employeeid, kpitype, endmonth, endyear, fstatus FROM kpi_list WHERE employeeid='$loggedid' AND status = 'Active' AND company='$companyMain' AND kpitype = 'Individual' GROUP BY endyear, endmonth, fstatus");
...
?>
                <tr>
                  ...
                  <td>
                    <a href="kpi4.php?et=<?php echo $employeeid2; ?>&y=<?php echo $endyear; ?>&m=<?php echo $endmonth; ?>" class="btn btn-dark tx-11 tx-uppercase pd-y-10 pd-x-15 tx-mont tx-medium">View</a>
                  </td>
                </tr>
<?php
}
...
<select id="whatterm" name="whatterm" class="form-control select2" onchange="showTerm();" required>
  ...
  <option value="2">Quarterly</option>
      ...
      <div class="form-group mg-l-10 mg-b-0-force" id="showdTerm">
