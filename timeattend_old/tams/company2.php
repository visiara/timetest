...
if ($comtype == "1") {
  $comtype2 = "Multi ClockIn";
} else {
  $comtype2 = "Single ClockIn";
}
    ...
    <div class=" mg-b-20">
      ...
      <div class="form-group mg-b-20-force">
        ...
        <select name="comtype" id="comtype" class="form-control" placeholder="Attendance Type" required>
          <option value="<?php echo $comtype; ?>"><?php echo $comtype2; ?></option>
      ...
      <div class="row mg-b-20">
        ...
        <div class="form-group mg-b-0 col-md-6">
          ...
          <input type="number" name="dvalue" class="form-control" min="1" value="<?php echo $dvalue; ?>" required>
        </div><!-- form-group -->
      </div>

      <div class="form-group mg-b-20-force">
        <label>Start Date: <span class="tx-danger">*</span></label>
        <input type="date" id="startdate2" name="startdate" class="form-control" placeholder="Start Date" value="<?php echo $comstartdate; ?>" required>
      </div><!-- form-group -->

      <div class="form-group mg-b-0-force">
        <label>No of User: <span class="tx-danger">*</span></label>
        <input type="number" id="noemployee" name="noemployee" class="form-control" min="10" placeholder="10" value="<?php echo $noemployee; ?>" required>
      </div>

      <!-- form-group 
      <div class="form-group mg-b-0-force">
        <label>End Date: <span class="tx-danger">*</span></label>
        <input type="date" id="enddate2" name="enddate" class="form-control" placeholder="End Date" value="<?php echo $comenddate; ?>" required>
      </div>
    -->
    </div>
