    ...
    <div class="container py-4">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <button class="btn primary-btn text-white" data-toggle="modal" data-target="#addemployee">+ Add Device Admin</button>
                    ...
                    <div class="card mb-3">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <img src="../images/profilepics/<?= $profilepic ?>" class="wd-60 ht-60 rounded-circle" alt="avatar">
                                <div>
                                    <h6 class="mb-0 text-black fs-4"><?= "$lname " . ucfirst(substr($mname, 0, 1)) . ". $fname" ?></h6>
                                    <small><?= $plevel ?></small><br>
                                </div>
                            </div>
                            <div class="text-start">
                                <strong class="fw-bold">Device ID:</strong>
                                <p class="fs-3"><?= $devicename ?></p>
                            </div>
                            <div class="text-start">
                                <strong class="fw-bold">Location:</strong>
                                <p class="fs-3"><?= $locationname ?></p>
                            </div>

                            <div class="text-end">

                                <div class="mt-2 d-flex gap-2">
                                    <button class="btn btn-light border rounded-btn" href="javascript:;" class="btn btn-primary btn-icon" onclick="Edit(<?php echo $eid; ?>);" data-toggle="modal" data-target="#editemployee">Edit</button>
                                    <button class="btn btn-light border rounded-btn" href="?activate=<?php echo $onoff; ?>&id=<?php echo $eid; ?>" class="btn <?php echo $btnactivate; ?> btn-icon" id="<?php echo $onoff; ?>" onclick="return confirmActivation(this.id);"><?= $buttonText ?></button>

                                    <a href="?did=<?php echo $eid; ?>" class="btn btn-danger rounded-btn border text-red" onclick="return confirmDelete();">
                                        <div>Delete</div>
                                    </a>
                                </div>
                            </div>
