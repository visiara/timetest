...
if (!empty($_GET['did'])) {
  ...
  //log event
  log_audit_event($uid, "UPDATE", "Updated record: $h3", "Devices", "success", '', '', $_SESSION['logged']);
...
*/
  ...
  if (mysqli_query($conn, $saveinsert1)) {
    ...
    log_audit_event($uid, "INSERT", "Inserted record: $dinsert", "Devices", "success", '', '', $_SESSION['logged']);
