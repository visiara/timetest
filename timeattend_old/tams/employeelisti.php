...
if (!empty($_GET['did'])) {
  ...
  //log event
  log_audit_event($uid, "DELETE", "DEleted record: $h3", "Employee Status", "success", '', '', $_SESSION['logged']);
  ...
  <div>
    <div class="br-pagetitle">
      ...
      <div>
        ...
        <p class="mg-b-0">User Management Panel - InActive Users.</p>
      </div>
    </div><!-- d-flex -->
    ...
    <div class="">
      <div>
        ...
        <?php echo $status; ?>
        <h4 class="mg-b-0">InActive Users</h4>
        <div class="table-wrapper mg-t-15">
          <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0 p-2" id="datatable1">
            ...
            <tbody>
              <?php
              $x = '0';
              $huserbd5 = mysqli_query($conn, "SELECT * FROM employee WHERE dele = '0' AND status = 'InActive' AND company='$companyMain'");
