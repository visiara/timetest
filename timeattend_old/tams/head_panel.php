    <div class="br-header">
      <div class="br-header-left">
        ...
        <div class="input-group hidden-xs-down wd-300 transition">
<?php
if(strtotime(date("Y-m-d", $comEnd1). ' - 30 days') <= time()){ ?>
  <h4 id="brDate2" class="br-date center" style="color:red !important;"> Expiry Date: <?php echo date("Y-m-d", $comEnd1); ?></h4>
<?php } else { ?>
  <h4 id="brDate2" class="br-date center" style="color:green !important;"> Expiry Date: <?php echo date("Y-m-d", $comEnd1); ?></h4>
<?php } ?>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="javascript:;" data-toggle="modal" data-target="#editprofile"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
...
<input type="hidden" name="changepassword" value="1">
    ...
    <div class=" mg-b-20">
      <div class="form-group mg-b-0-force">
        ...
        <input type="text" name="pword" class="form-control" placeholder="Password" value="<?php echo $pwd; ?>" required>
      </div><!-- form-group -->
    </div>
...
<input type="hidden" name="ison" value="1">
                  <div class="row no-gutters">
                    <!-- col-12 -->
                    <div class="col-lg-12 bg-white">
                      <div class="pd-20 tx-center mg-t-30">
                          <i class="fa fa-lock fa-5x mg-b-30" aria-hidden="true"></i>
                          <h3 class="tx-inverse mg-b-25">Access Period Expired!</h3>
                          Your HECKER PEOPLE <?php echo "$dvalueMain $dtypeMain"; ?> subscrioption has expired.
                          <p>To purchase a time extension for your current package or to upgrade to a package with additional feature, contact admin.</p>
