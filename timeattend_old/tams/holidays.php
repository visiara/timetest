...
if (!empty($_GET['activate'])) {
  ...
  //log event
  log_audit_event($uid, "UPDATE", "Updated record: $id", "Holiday", "success", '', '', $_SESSION['logged']);
...
if (!empty($_GET['did'])) {
  ...
  //log event
  log_audit_event($uid, "DELETE", "Deleted record: $h3", "Holiday", "success", '', '', $_SESSION['logged']);
...
if (!empty($_POST['editp'])) {
  ...
  if (mysqli_query($conn, $saveinsert1)) {
    ...
    //log event
    log_audit_event($uid, "UPDATE", "Updated record: $theid", "Holiday", "success", '', '', $_SESSION['logged']);
...
*/
  ...
  if (mysqli_query($conn, $saveinsert1)) {
    ...
    log_audit_event($uid, "INSERT", "Inserted record: $dinsert", "Holiday", "success", '', '', $_SESSION['logged']);
  ...
  <div>
    ...
    <div class="">
      <div>
        ...
        <?php echo $status; ?>
        <button class="btn btn-teal" data-toggle="modal" data-target="#addemployee"><i class="fa fa-plus mg-r-10"></i> Add Holidays</button>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php if (($todaysdate > $startdate) || ($todaysdate > $enddate)) {
                    } else { ?>
