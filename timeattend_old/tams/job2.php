  ...
  <div class="widget-2">
    <div class="card pd-25">
      ...
      <div class="card-header bd-b-0">
        <h5 class="tx-uppercase tx-inverse tx-bold">Active Jobs</h5>

        <div class="d-flex justify-content-end">
          <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" onclick="showPage('jobmanagement2.php')" class="btn btn-secondary pd-x-30">All</button>
            <button type="button" onclick="showPage('job2.php')" class="btn btn-secondary pd-x-30 active">Active</button>
        ...
        <div id="rickshaw1222" class="wd-100p rounded-bottom">
          ...
          <table id="mainTableClass" class="table table-bordered display responsive mainTableClass">
            ...
            <tbody id="requisitions-table">
              <?php
              $x = 0;
              $result = $conn->query("SELECT * FROM jobs_details_settings WHERE job_status = 'Active' AND company='$companyMain' ORDER BY id desc");
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu pd-10 wd-200">
                        <nav class="nav nav-style-2 flex-column">
                          ...
                          <a href="#" class="nav-link" onclick='doJobs("<?php echo $dobid; ?>",1,"job2.php")'>Suspend Job</a>
                          <a href="#" class="nav-link" onclick='doJobs("<?php echo $dobid; ?>",2,"job2.php")'>Add to Drafts</a>
                          <a href="#" class="nav-link" onclick='doJobs("<?php echo $dobid; ?>",3,"job2.php")'>Delete Job</a>
                        </nav>
                      </div><!-- dropdown-menu -->
                    </div><!-- dropdown -->
                  </td>
