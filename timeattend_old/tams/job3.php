  ...
  <div class="widget-2">
    <div class="card pd-25">
      ...
      <div class="card-header bd-b-0">
        <h5 class="tx-uppercase tx-inverse tx-bold">Drafts Jobs</h5>
        ...
        <div class="d-flex justify-content-end">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <button type="button" onclick="showPage('job3.php')" class="btn btn-secondary pd-x-30 active">Drafts</button>
        ...
        <div id="rickshaw1222" class="wd-100p rounded-bottom">
          ...
          <table id="mainTableClass" class="table table-bordered display responsive mainTableClass">
            ...
            <tbody id="requisitions-table">
              <?php
              $x = 0;
              $result = $conn->query("SELECT * FROM jobs_details_settings WHERE job_status = 'Draft' AND company = '$companyMain' ORDER BY id desc");
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu pd-10 wd-200">
                        <nav class="nav nav-style-2 flex-column">
                          ...
                          <a href="#" class="nav-link" onclick='postJobs("<?php echo $dobid; ?>",2,"job3.php")'>Post Job</a>
                          <a href="#" class="nav-link" onclick='doJobs("<?php echo $dobid; ?>",3,"job3.php")'>Delete Job</a>
                        </nav>
                      </div><!-- dropdown-menu -->
                    </div><!-- dropdown -->
                  </td>
