...
?>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="template_name" value="<?php echo $row['workflow_name']; ?>" required>
  </div>

  <div class="form-group">
    <label>Description<span class="tx-danger">*</span></label>
    <textarea class="form-control" name="template_desc" required><?php echo $row['workflow_desc']; ?></textarea>
  </div>
