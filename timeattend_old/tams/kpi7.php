...
if (!empty($_POST['editp'])) {
  ...
  if (mysqli_query($conn, $saveinsert1)) {
    ...
    //log event
    log_audit_event($uid, "UPDATE", "Updated record: $theid", "KPI Detail", "success", '', '', $_SESSION['logged']);
    ...
    <div class="">
      <div>
        ...
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="kpi8.php?et=<?php echo $theemployee; ?>&y=<?php echo $y; ?>&m=<?php echo $m; ?>" class="btn btn-teal"><i class="fa fa-file mg-r-10"></i> Grade All KPIs</a>
        </div>
        ...
        <div class="table-wrapper mg-t-15">
          <table id="datatable1" class="table table-bordered display responsive">
            ...
            <tbody>
              ...
              //if($user_role == "3"){
              $huserbd5 = mysqli_query($conn, "SELECT * FROM kpi_list WHERE status = 'Active' AND company='$companyMain' AND employeeid = '$theemployee' AND endyear = '$y' AND endmonth = '$m' AND (dpoll='0' OR fstatus='2')");
...
<div class="progress ht-30">
  <div class="progress-bar <?php echo $statusd; ?> wd-100p" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"><?php echo $status; ?></div>
                  ...
                  <td><a href="" class="btn btn-dark tx-11 tx-uppercase pd-y-10 pd-x-15 tx-mont tx-medium" data-toggle="modal" data-target="#modaldemo6" onclick="show2(<?php echo $eid; ?>);">Grade</a></td>
            ...
            <tfoot class="thead-colored thead-dark">
              <tr>
                ...
                <td class=""><?php //echo "$totalach%"; 
                              ?></td>
                <td class=""><?php //echo "$totalschore%"; 
                              ?></td>
