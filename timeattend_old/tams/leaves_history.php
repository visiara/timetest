  ...
  <div>
    <div class="br-pagetitle">
      ...
      <div>
        ...
        <p class="mg-b-0">User Leave History Panel - All Users.</p>
      </div>
    </div><!-- d-flex -->
          ...
          <div class="table-wrapper mg-t-15">
            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0 p-2" id="datatable1">
              ...
              <tbody>
                ...
                if ($user_role == "3") {
                  $huserbd5 = mysqli_query($conn, "SELECT * FROM leaves WHERE (approvals = '0' OR approvals = '9') AND company='$companyMain' AND department='$loggeddepartment'");
                } else {
                  $huserbd5 = mysqli_query($conn, "SELECT * FROM leaves WHERE (approvals = '0' OR approvals = '9') AND company='$companyMain'");
                }
