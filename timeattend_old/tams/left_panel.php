  ...
  -->
        ...
        ?>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub <?php echo $where15; ?>">
            <i class="fa fa-tasks tx-18"></i>
            <span class="menu-item-label">Recruitment</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="recruitment.php" class="sub-link <?php echo $where15a; ?>">Recruitment Management</a></li>
            <li class="sub-item"><a href="jobmanagement.php" class="sub-link <?php echo $where15b; ?>">Job Management</a></li>
            <li class="sub-item"><a href="templates.php" class="sub-link <?php echo $where15c; ?>">Template Management</a></li>
            <li class="sub-item"><a href="settings.php" class="sub-link <?php echo $where15d; ?>">Recruitment settings</a></li>
            <!--
        <li class="sub-item"><a href="kpi4.php" class="sub-link <?php echo $where13e; ?>">Work Shift Type</a></li>
        <li class="sub-item"><a href="kpi5.php" class="sub-link <?php echo $where13f; ?>">Salary Scale</a></li>
  -->
        ...
        ?>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub <?php echo $where16; ?>">
            <i class="fa fa-folder-open tx-18"></i>
            <span class="menu-item-label">HRDA (Document Archive)</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="assetmanagement.php" class="sub-link <?php echo $where16a; ?>">Document Archive</a></li>
            <!--<li class="sub-item"><a href="jobmanagement.php" class="sub-link <?php echo $where16b; ?>">Job Management</a></li>
        <li class="sub-item"><a href="templates.php" class="sub-link <?php echo $where16c; ?>">Template Management</a></li>
        <li class="sub-item"><a href="settings.php" class="sub-link <?php echo $where16d; ?>">Recruitment settings</a></li>-->
          </ul>
        </li><!-- br-menu-item -->
        <?php //} 
        ?>
        ...
        <?php if (($user_role == "4")) { ?>
          <li class="br-menu-item">
            ...
            <ul class="br-menu-sub nav flex-column"></ul>
