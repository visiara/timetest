...
$bookpay1 = mysqli_query($conn, "SELECT * FROM salary_allowance WHERE id = '$q'");
while ($bookpay = mysqli_fetch_array($bookpay1)) {
  $eidy = $bookpay["id"];
  $name = $bookpay["name"];
  $dvalue = $bookpay["dvalue"];
  $salaryscale = $bookpay["salaryscale"];
  $comallow = $bookpay["theprimary"];
}
  ...
  <div class="pd-20">
    ...
    <div class="mg-b-20">
      ...
      <div class="mg-t-30">
        <div class="form-group mg-b-0">
          <label class="ckbox">
            <input type="checkbox" name="comallow" value="1" <?php echo $comallow2; ?>>
