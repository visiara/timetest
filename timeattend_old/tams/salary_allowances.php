...
if ($type == 1) {
    ...
    log_audit_event($uid, "INSERT", "Inserted record: $dinsert", "Salary Allowance Other", "success", '', '', $_SESSION['logged']);
}
...
if ($type == 3) {
    ...
    //log event
    $dinsert = mysqli_insert_id($conn);
    log_audit_event($uid, "DELETE", "Deleted record: $todelete", "Allowance", "success", '', '', $_SESSION['logged']);
}
