...
<body>
  ...
  <!-- ########## START: MAIN PANEL ########## -->
  <div>
    <div class="ht-md-80 wd-200 wd-md-auto bg-dark pd-y-20 pd-md-y-0 pd-md-x-20 d-md-flex align-items-center justify-content-center">
      <ul class="nav nav-effect nav-effect-4 flex-column flex-md-row" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#" role="tab">Job Requisitions</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#" role="tab">Published Jobs</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#" role="tab">Applicant Pool</a></li>
      </ul>
    </div><!-- ht-65 -->
