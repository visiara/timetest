  ...
  <div class="widget-2">
    <div class="card pd-25">
      ...
      <div class="card-header bd-b-0">
        <h5 class="tx-uppercase tx-inverse tx-bold">Email Templates</h5>

        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#newRequisitionModal">New Template</button>
        ...
        <div id="rickshaw1222" class="wd-100p rounded-bottom">
          ...
          <table id="mainTableClass" class="table table-bordered display responsive mainTableClass">
            ...
            <tbody id="requisitions-table">
              <?php
              $x = 0;
              $result = $conn->query("SELECT * FROM job_template_email WHERE company='$companyMain' ORDER BY id desc");
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu pd-10 wd-200">
                        <nav class="nav nav-style-2 flex-column">
                          <a href="#" class="nav-link" onclick='viewTemplate("<?php echo $dobid; ?>")'>Edit Template</a>
                          <a href="#" class="nav-link" onclick='deleteTemplate("<?php echo $dobid; ?>")'>Delete Template</a>
                        </nav>
                      </div><!-- dropdown-menu -->
                    </div><!-- dropdown -->
                  </td>
