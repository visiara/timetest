...
$result = $conn->query("SELECT * FROM job_template_email WHERE id = '$job_id'");
while ($row = $result->fetch_assoc()) {
?>
  <input type="hidden" name="updatetemplate1" value="1">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="template_body" required><?php echo $row['template_body']; ?></textarea>
  </div>
